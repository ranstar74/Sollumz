...
from ..tools.elfhash import generate

# https://github.com/dexyfex/CodeWalker/blob/8998b8c808a8ac234f32a2928108ac38874add69/CodeWalker.Core/GameFiles/Resources/Drawable.cs#L1731
bone_tags = {
    'SKEL_ROOT': 0x0,
    'SKEL_Pelvis': 0x2E28,
    'SKEL_L_Thigh': 0xE39F,
...
def try_get_bone_tag(bone_name):
    """Tries to get bone tag by bone name. If tag wasn't found, new one is created using ELF Hash."""
    if contains(bone_tags, bone_name):
        return bone_tags[bone_name]

    return generate(bone_name)
